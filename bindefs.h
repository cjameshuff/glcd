//************************************************************************************************
// avr-gcc no longer supports the 0bXXXXXXXX binary literals extension, so...
// 
// This code is released into the public domain, and may be freely used for any purpose.
//************************************************************************************************
/*
// g++ genbindefs.cpp -o genbindefs; ./genbindefs
...
void PrintBin(uint32_t val, int bits, char one, char zero)
{
    for(int j = bits - 1; j >= 0; --j)
        cout << ((val & (1 << j))? one : zero);
}

void PrintBinDefs(int bits, const string & prefix, char one, char zero)
{
    for(int j = 0; j < (1 << bits); ++j) {
        cout << "#define " << prefix;
        PrintBin(j, bits, one, zero);
...
{
	cout << "\n// 2 bits" << endl;
	PrintBinDefs(2, "b", '1', '0');
	cout << "\n// 3 bits" << endl;
	PrintBinDefs(3, "b", '1', '0');
	cout << "\n// 4 bits" << endl;
	PrintBinDefs(4, "b", '1', '0');
	cout << "\n// 8 bits" << endl;
	PrintBinDefs(8, "b", '1', '0');
	cout << "\n// Underscore/O definitions for declaring bitmaps" << endl;
	PrintBinDefs(8, "", 'O', '_');
...
// Underscore/O definitions for declaring bitmaps
#define ________ (0x0)
#define _______O (0x1)
#define ______O_ (0x2)
#define ______OO (0x3)
